...
import com.hudson.wanandroid.ui.adapter.viewholder.FragmentViewHolder;
...
/**
 * 这种方式下，Fragment不会被销毁，所有的Fragment都会被缓存
 */
public abstract class MyFragmentStateAdapter extends
     ...
     * @see androidx.viewpager2.adapter.FragmentStateAdapter#FragmentStateAdapter(Fragment)
     */
    public MyFragmentStateAdapter(@NonNull FragmentManager fragmentManager,
